          ...
          {mode === "login" ? (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="mt-3 pt-3 border-t text-center" style={{ borderColor: "var(--border-default)" }}>
                <p className="text-[11px]" style={{ color: "var(--text-tertiary)" }}>Demo: admin@whatsapp-panel.com / admin123</p>
              </div>
            </form>
          ) : (
            <form onSubmit={handleRegister} className="space-y-3">
              <div>
                <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--text-secondary)" }}>
                  <Building2 size={12} className="inline mr-1" />Nombre de tu organizacion
                </label>
                <input value={orgName} onChange={(e) => setOrgName(e.target.value)} className="input" placeholder="Mi Empresa SA" required autoFocus />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--text-secondary)" }}>Tu nombre</label>
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5" style={{ color: "var(--text-secondary)" }}>Contrasena (min 6)</label>
